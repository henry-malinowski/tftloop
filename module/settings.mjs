import { tftloop } from "./config.mjs";
...
export const registerSystemSettings = function () {
  ...
  game.settings.register("tftloop", "uiTheme", {
    name: "SETTINGS.uiTheme",
    ...
    type: String,
    choices: {
      "theme-loop": "SETTINGS.uiThemeLoop",
      "theme-flood": "SETTINGS.uiThemeFlood",
    },
    onChange: (value) => {
      // Update body theme class
      const body = document.body;
      body.classList.remove("theme-loop", "theme-flood");
